...
export declare type CalendarPickerCellProps<D> = StyledComponentProps & ComponentProps<D>;
export declare type CalendarPickerCellElement<D> = React.ReactElement<CalendarPickerCellProps<D>>;
export declare const CalendarPickerCell: import("../../../../theme").StyledComponentClass<CalendarPickerCellProps<unknown>>;
export {};
