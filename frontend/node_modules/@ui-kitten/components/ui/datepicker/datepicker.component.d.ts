...
export declare type DatepickerProps<D = Date> = BaseDatepickerProps<D> & CalendarProps<D>;
 ...
 */
export declare class DatepickerComponent<D = Date> extends BaseDatepickerComponent<DatepickerProps<D>, D> {
    static styledComponentName: string;
    protected getComponentTitle(): string;
    protected renderCalendar(): CalendarElement<D>;
}
export declare const Datepicker: import("../../theme").StyledComponentClass<DatepickerProps<Date>>;
